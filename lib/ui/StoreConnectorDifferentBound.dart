...
class DifferentBoundState extends State<DifferentBound>
  ...
  Widget build(BuildContext context) {
    return StoreConnector<ButtonListState, List>(
        converter: (Store<ButtonListState> store) =>
            tempppppp = store.state.availableList,
        builder: (BuildContext context, List availableList) {
          return Container(
                                          ...
                                          children: [
                                            Container(
                                              margin: EdgeInsets.only(
                                                  left: 10, right: 10),
                                              child: Text(
                                                widget.passInBoundBasicInfo[
                                                    widget.passInGetBoundResult
                                                        .indexOf(item)][0],
                                                style: font20White,
                                              ),
                                            ),
